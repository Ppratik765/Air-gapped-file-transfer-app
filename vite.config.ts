...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://github.com/Ppratik765/Offline-file-transfer-app/";
...
//   standalone-send     one self-contained wavedrop-sender.html
//   standalone-receive  one self-contained wavedrop-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        emitAs(outDir, `${page}/index.html`, `wavedrop-${page === "send" ? "sender" : "receiver"}.html`),
      ],
